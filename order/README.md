...
│   ├── api/
│   │   ├── controller/
│   │   │   └── OrderController.kt           # Handles /orders HTTP requests
│   │   └── routes/
...
│   │   │   └── OrderServiceFacade.kt        # Facade for order coordination
│   │   ├── handler/
│   │   │   └── OrderEventHandler.kt         # Handles PaymentProcessedEvent
│   │   └── mapper/
...
│   │   └── event/
│   │       └── OrderSpecificEvent.kt         # Module-specific events (placeholder)
│   ├── data/
│   │   ├── entity/
