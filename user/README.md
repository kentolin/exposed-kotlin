...
│   ├── api/
│   │   ├── controller/
│   │   │   └── UserController.kt            # Handles /users HTTP requests
│   │   └── routes/
...
│   │   │   └── UserServiceFacade.kt         # Facade for user coordination
│   │   ├── handler/
│   │   │   └── UserEventHandler.kt          # Handles OrderCreatedEvent
│   │   └── mapper/
...
│   │   └── event/
│   │       └── UserSpecificEvent.kt          # Module-specific events (placeholder)
│   ├── data/
│   │   ├── entity/
